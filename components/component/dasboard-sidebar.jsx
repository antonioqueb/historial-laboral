...
export default function DashboardSidebar() {
  ...
  return (
    <div className="fixed inset-y-0 left-0 z-50 flex flex-col min-h-screen max-w-[280px] dark:bg-zinc-900 transition-transform transform translate-x-0 md:relative">
      {/* Sidebar for desktop */}
